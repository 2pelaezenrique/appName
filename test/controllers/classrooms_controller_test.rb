...
class ClassroomsControllerTest < ActionController::TestCase
  ...
  test "should create classroom" do
    assert_difference('Classroom.count') do
      post :create, classroom: { college: @classroom.college, name: @classroom.name, password: @classroom.password, public: @classroom.public }
    end
  ...
  test "should update classroom" do
    patch :update, id: @classroom, classroom: { college: @classroom.college, name: @classroom.name, password: @classroom.password, public: @classroom.public }
    assert_redirected_to classroom_path(assigns(:classroom))
  end
